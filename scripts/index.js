...
const kanyehidden = document.getElementsByClassName('box-position');
const kanye1 = document.getElementById("kanye");
...
const seq = {
  seq1: ["kick-light", "snare-light", "kick-light", "snare-light",
         ...
         "kick2-light", "snare2-light", "kick2-light", "kick2-light",  "snare2-light",
...
function checkStep(index, button) {
  ...
  if (seq.seq1[index] === button.id) {
    ...
    addScore();
  } else if (seq.seq1[index] !== button.id) {
    start.innerHTML = "GAME OVER";
    kanye1.innerHTML = "<img src=\img/Kanye3.png\ width=\'25%\' height=\'25%\'>";
    stopAllSetTimeout();
    replayGame();
  } 
...
function addScore() {
  ...
  if (currentScore===1 || currentScore===2 ||
    currentScore===3 || currentScore===4){
     kanye1.innerHTML = "<img src=\img/Kanye-West-5.png\ width=\'12%\' height=\'10%\'>";
  }
  if (currentScore===5 || currentScore===6 ||
    currentScore===7 || currentScore===8 || currentScore===9){
     kanye1.innerHTML = "<img src=\img/Kanye-West-9.png\ width=\'6%\' height=\'8%\'>";
  }
  if (currentScore===10 || currentScore===11 ||
    currentScore===12 || currentScore===13){
     kanye1.innerHTML = "<img src=\img/Kanye-West-13.png\ width=\'6%\' height=\'8%\'>";
  }
  if (currentScore===13 || currentScore===14 ||
    currentScore===15 || currentScore===16 || currentScore===17){
     kanye1.innerHTML = "<img src=\img/Kanye-West-15.png\ width=\'8%\' height=\'9%\'>";
  }
  if (currentScore===18){
     kanye1.innerHTML = "<img src=\img/Kanye-West-win.png\ width=\'23%\' height=\'23%\'>";
     start.innerHTML = "YOU ARE THE NEW MPC GOD";
     replayGame();
  }
...
function lightseq(){
  ...
  controlLight(snare2L,29600,false);
  //
  controlLight(kick2L,29800);
  controlLight(kick2L,31300,false);
  controlLight(snare2L,31300);
  controlLight(snare2L,32700,false);
  controlLight(kick2L,32800);
  controlLight(kick2L,33500,false);
  controlLight(kick2L,33700);
  controlLight(kick2L,34300,false);
  controlLight(snare2L,34400);
  controlLight(snare2L,35200,false);
}
